...
export const SLOT_CONFIG = [
  // ── Chapter 1 ──────────────────────────────────────────────────────────────
  { slot_id: "ch1-kitchen",         chapter: "Ch1", order_index: 1,  label: "Jackie tippy-toeing into kitchen — arms overflowing with treasures (turquoise tin, bagpipe, tea cozy, woolly jumper, shortbread tins going clinkety-clink)" },
  ...
  { slot_id: "ch1-five-characters", chapter: "Ch1", order_index: 3,  label: "All five finished tin toys lined up on the table — still, eyes closed, waiting" },
  { slot_id: "ch1-incantation",     chapter: "Ch1", order_index: 4,  label: "Jackie kneeling, glitter cascading from raised pan onto five tin characters in a circle — dark kitchen, golden glitter the only light, 'just a pinch of magic will do' in condensation on window" },
  ...
  { slot_id: "ch1-sam",             chapter: "Ch1", order_index: 9,  label: "Shortbread Sam opening chest window — golden square body, neat bow tie, offering Jackie a shortbread (clink-clank!)" },
  ...
  // ── Chapter 2 ──────────────────────────────────────────────────────────────
  { slot_id: "ch2-wagon",           chapter: "Ch2", order_index: 11, label: "Jackie pulling the red wagon — five characters piled in, ancient tree visible, soft grey rainy sky" },
  { slot_id: "ch2-oak-greeting",    chapter: "Ch2", order_index: 12, label: "Jackie pressing both palms flat against the old oak — face close, eyes closed, quiet and warm in the rain" },
  { slot_id: "ch2-oak-pocket",      chapter: "Ch2", order_index: 13, label: "Jackie crouching at the base of the old oak — reaching for a single glowing acorn, puddle moat reflecting amber glow" },
  { slot_id: "ch2-scotchbot-spots", chapter: "Ch2", order_index: 14, label: "Scotch Bot frozen mid-wobble — golden medallion whirling, one eye fixed on the magnificent puddle system (whizz-beep-BEEP!) [NEED]" },
  ...
  { slot_id: "ch2-orchestra",       chapter: "Ch2", order_index: 20, label: "Jackie conducting the muddy orchestra — oak twig wand raised, all five mid-sound, cheeky Scottish sun peeking through" },
  { slot_id: "ch2-reveal",          chapter: "Ch2", order_index: 21, label: "REVEAL — the old oak in the rain. Tiny handmade stage, red fabric curtain. Five still tin toys propped around it. Solar light glowing." },
