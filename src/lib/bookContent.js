...
export const BOOK_CHAPTERS = [
  {
    ...
    blocks: [
      ...
      { type: 'slot', slot_id: 'ch1-five-characters', order_index: 3, label: 'All five finished tin toy characters lined up on the kitchen table — still, eyes closed, waiting' },
      ...
      { type: 'slot', slot_id: 'ch1-scotchbot', order_index: 5, label: 'Scotch Bot — turquoise body, golden medallion spinning (whizz-beep!)' },
      { type: 'text', content: 'From tins and springs and swirly things — (whizz-beep!) — Scotch Bot!' },
      { type: 'slot', slot_id: 'ch1-bagpipebot', order_index: 6, label: "Bagpipe Bot — tartan kilt, tam o'shanter flopping (toot-toot-wheeze!)" },
      ...
      { type: 'slot', slot_id: 'ch1-woolywatt', order_index: 8, label: 'Woolie Watt — purple woolly jumper, wild orange wire hair (zip-zap!)' },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'slot', slot_id: 'ch2-oak-greeting', order_index: 12, label: 'Jackie pressing both palms flat against the old oak — face close, eyes closed' },
      { type: 'text', content: 'She pressed both palms flat against the old oak. Face close. Eyes closed. "Hello," she said quietly. "I brought everyone." Something answered.' },
      { type: 'slot', slot_id: 'ch2-oak-pocket', order_index: 13, label: 'Jackie crouching at the base of the old oak — reaching down to pick up a single glowing acorn' },
      { type: 'text', content: 'There — at the very base of the old oak — a single acorn. Glowing amber. She picked it up with both hands. A quiet (tock) as it landed in her palm. She patted her pouch (pat-pat) and tucked it safely inside. She would keep it forever.' },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'text', content: 'Woolie Watt stopped mid-spin.\n\nHis wild orange hair crackled. His eyes went sideways.\n\nThere — at the edge of his vision — a sparkle. A whisp. A trace of something that wasn\'t quite light and wasn\'t quite not.\n\n(zip?)\n\nThen the sheep appeared.' },
      { type: 'slot', slot_id: 'ch3-random-appears', order_index: 25.2, label: 'Random sitting in the middle of the Rainbow Cave — small, fluffy, completely unbothered. Jackie staring at it.' },
      { type: 'text', content: 'It was small. It was fluffy. It was sitting in the middle of the Rainbow Cave as if it had always been there and everyone else was the problem.\n\nJackie looked at it for a long moment.\n\n"Did someone," she said carefully, "lose a sheep?"' },
      { type: 'slot', slot_id: 'ch3-fae-appears', order_index: 25.3, label: 'Fae Fickle appearing — spear raised, hand on hip, pointing directly at Jackie. The crew frozen behind her.' },
      { type: 'text', content: 'The air shimmered.\n\nFae Fickle appeared.\n\nSmall. Wiry. Enormous copper cloud of hair. Spear. Expression.\n\n"He\'s Random," she said. "And the real question —"\n\nShe pointed her spear directly at Jackie.\n\n"— is why are YOU in MY cave."' },
      { type: 'slot', slot_id: 'ch3-chard-moment', order_index: 25.4, label: 'Fae Fickle holding rainbow chard leaf up to the crystal light — spear lowered, expression completely changed, reverent' },
      { type: 'text', content: 'She drew herself up and opened her mouth to say something very firm indeed.\n\nThen she saw the rainbow chard.\n\nHer spear lowered approximately three inches.\n\nShe turned it over in her hands. Held a leaf up to the crystal light. Sniffed it.' },
      { type: 'slot', slot_id: 'ch3-garden-fairy-line', order_index: 25.5, label: 'CLOSE UP — Fae Fickle looking directly at Jackie, chard held to her chest, deadly serious. The 632 years line.' },
  ...
  },
  {
    ...
    chapterKey: 'Ch4',
    blocks: [
      { type: 'slot', slot_id: 'ch4-whistle', order_index: 27, label: 'Jackie finding the brass whistle among the rainbow pebbles' },
      ...
      { type: 'slot', slot_id: 'ch4-windship', order_index: 28, label: 'The windship — the red wagon transformed, dragonfly-wing sails unfurling' },
      ...
      { type: 'slot', slot_id: 'ch4-cloud-castle', order_index: 29, label: 'The Cloud Castle — vast hall of dancing colours, the Cloud Keeper present, Jackie and characters in awe' },
      ...
      { type: 'slot', slot_id: 'ch4-storm', order_index: 30, label: 'THE STORM KING BATTLE — Jackie at the wagon helm, wand raised, dark storm cloud above' },
